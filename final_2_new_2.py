...
class DefenderWrapperWithRLFiring(gym.Env):
    ...
    def __init__(self, defender_id=0,
                 total_num_def=6,  # ✅ CHANGED: Updated to 6 defenders
    ...
    def reset(self, *, seed=None, options=None):
        """Reset with RL-based firing system."""
    ...
    def step(self, action):
        """Step with RL-BASED firing control and enhanced success tracking."""
        self.step_count += 1
...
# Training function with RL-based firing system
def train_rl_firing_system(defender_id=0, total_timesteps=50000):
    ...
    ✅ ENHANCED: Now includes torpedo hit detection fixes and success tracking.
    """
    ...
    # Create environment with RL firing
    env = DefenderWrapperWithRLFiring(defender_id=defender_id)

    # Validation test
    print("\nValidating RL firing system with enhanced hit detection...")
    try:
        obs, info = env.reset()
        ...
        print("🎉 RL FIRING SYSTEM WITH ENHANCED HIT DETECTION IS WORKING!")
    ...
    print(f"\nStarting RL firing training for {total_timesteps} timesteps...")
    ...
    try:
        ...
        save_path = f"rl_firing_defender_{defender_id}_{defender_type}_enhanced"
        model.save(save_path)
        print(f"✓ Training completed! Model saved: {save_path}")

        # Test trained model
        print("\nTesting trained RL firing model with enhanced hit detection...")
        test_results = []
        ...
        print(f"\n🎯 RL FIRING INTELLIGENCE ANALYSIS:")
...
if __name__ == "__main__":
    print("🎯 RL-BASED FIRING SYSTEM TRAINING - ENHANCED VERSION")
    print("=" * 70)
    ...
    # ✅ NEW: Train all 6 defenders individually
    print("\n🎯 TRAINING ALL 6 DEFENDERS INDIVIDUALLY - ENHANCED")
    print("=" * 50)
    
    trained_models = {}
    
    for defender_id in range(6):
        print(f"\n🚀 STARTING ENHANCED TRAINING FOR DEFENDER {defender_id}")
        print("-" * 40)
        ...
        if model and save_path:
            ...
            print(f"✅ Defender {defender_id} enhanced training completed!")
        else:
            trained_models[defender_id] = {
                'model': None,
                'save_path': None,
            ...
            print(f"❌ Defender {defender_id} enhanced training failed!")
    
    # Summary of all training
    print("\n" + "=" * 70)
    print("🎉 ALL ENHANCED DEFENDER TRAINING COMPLETED!")
    print("=" * 70)
    ...
    if successful_trainings == 6:
        print("\n🎉 PERFECT! All 6 defenders trained successfully with enhanced features!")
        print("Your naval defense fleet is ready for deployment!")
        print("\nEnhanced capabilities developed:")
